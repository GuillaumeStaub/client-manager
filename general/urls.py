...
urlpatterns = [
    ...
    path('commande/update/<int:pk>', views.CommandeUpdateView.as_view(), name='comande_update'),
    path('commande/create/', views.CommandeCreateView.as_view(), name='commande_create'),
    ...
    path('ajax_search/commande/', views.commande_search_view, name='ajax_search_client'),
